...
static Platform platforms[MAX_PLATFORMS] = {
    {p3_tex, Vector2{0, 896 - 32}, Rectangle{0}, 2.0f}, // No collider
    {p5_tex, Vector2{0, 896 - 160}, Rectangle{0, 896 - 160, 64 * 2, 64 * 2}, 2.0f},
    {p14_tex, Vector2{128, 896 - 32}, Rectangle{128, 896 - 32, 64 * 2, 64 * 2}, 2.0f},
    {p5_tex, Vector2{128 + 2 * 64, 896 - 32}, Rectangle{128 + 2 * 64, 896 - 32, 64 * 2, 64 * 2}, 2.0f},
    {p6_tex, Vector2{128, 896 - 160}, Rectangle{128, 896 - 160, 64 * 2, 64 * 2}, 2.0f},
    {p5_tex, Vector2{128 + 3 * 64, 896 - 32}, Rectangle{128 + 3 * 64, 896 - 32, 64 * 2, 64 * 2}, 2.0f},
    {p3_tex, Vector2{128 + 4 * 64, 896 - 32 - 64}, Rectangle{0}, 2.0f}, // No collider
    {p13_tex, Vector2{128 + 4 * 64, 896 - 32}, Rectangle{128 + 4 * 64, 896 - 32, 64 * 2, 64 * 2}, 2.0f},
    {p4_tex, Vector2{128 + 4 * 64, 896 - 32 - 128}, Rectangle{128 + 4 * 64, 896 - 32 - 128, 64 * 2, 64 * 2}, 2.0f},
    {p3_tex, Vector2{128 + 6 * 64, 896 - 32}, Rectangle{0}, 2.0f}, // No collider
    {p6_tex, Vector2{128 + 6 * 64, 896 - 32 - 128}, Rectangle{128 + 6 * 64, 896 - 32 - 128, 64 * 2, 64 * 2}, 2.0f},
    {p4_tex, Vector2{12 * 64, 896 - 32}, Rectangle{12 * 64, 896 - 32, 64 * 2, 64 * 2}, 2.0f},
    {p5_tex, Vector2{13 * 64, 896 - 32}, Rectangle{13 * 64, 896 - 32, 64 * 2, 64 * 2}, 2.0f},
    {p5_tex, Vector2{14 * 64, 896 - 32}, Rectangle{14 * 64, 896 - 32, 64 * 2, 64 * 2}, 2.0f},
    {p13_tex, Vector2{16 * 64, 896 - 32}, Rectangle{16 * 64, 896 - 32, 64 * 2, 64 * 2}, 2.0f},
    {p4_tex, Vector2{16 * 64, 896 - 160}, Rectangle{16 * 64, 896 - 160, 64 * 2, 64 * 2}, 2.0f},
    {p3_tex, Vector2{18 * 64, 896 - 32}, Rectangle{18 * 64, 896 - 32, 64 * 2, 64 * 2}, 2.0f},
    {p5_tex, Vector2{18 * 64, 896 - 160}, Rectangle{18 * 64, 896 - 160, 64 * 2, 64 * 2}, 2.0f},
    {p2_tex, Vector2{200, 400}, Rectangle{200, 400, 64 * 2, 64 * 2}, 2.0f},
    {p15_tex, Vector2{500, 400}, Rectangle{500, 400, 64 * 2, 64 * 2}, 2.0f},
    {p16_tex, Vector2{500 + 126, 400}, Rectangle{500 + 126, 400, 64 * 2, 64 * 2}, 2.0f},
    {p24_tex, Vector2{900, 200}, Rectangle{900, 200, 64 * 2, 64 * 2}, 2.0f},
    {p25_tex, Vector2{900 + 126, 200}, Rectangle{900 + 126, 200, 64 * 2, 64 * 2}, 2.0f},
};
...
static void InitPlatforms(void)
{
    ...
    platforms[0].tex = p3_tex;
    platforms[1].tex = p5_tex;
    platforms[2].tex = p14_tex;
    platforms[3].tex = p5_tex;
    platforms[4].tex = p6_tex;
    platforms[5].tex = p5_tex;
    platforms[6].tex = p3_tex;
    platforms[7].tex = p13_tex;
    platforms[8].tex = p4_tex;
    platforms[9].tex = p3_tex;
    platforms[10].tex = p6_tex;
    platforms[11].tex = p4_tex;
    platforms[12].tex = p5_tex;
    platforms[13].tex = p5_tex;
    platforms[14].tex = p13_tex;
    platforms[15].tex = p4_tex;
    platforms[16].tex = p3_tex;
    platforms[17].tex = p5_tex;
    platforms[18].tex = p2_tex;
    platforms[19].tex = p15_tex;
    platforms[20].tex = p16_tex;
    platforms[21].tex = p24_tex;
    platforms[22].tex = p25_tex;
...
static void DrawPlatforms(void)
{
    ...
    {
        DrawTextureEx(platforms[i].tex, platforms[i].position, 0.0f, platforms[i].scale, WHITE);                               // Draw platform
        // DrawRectangleLines(platforms[i].rect.x, platforms[i].rect.y, platforms[i].rect.width, platforms[i].rect.height, BLUE); // Draw platform collider
    }
...
static void CheckCollision()
{
    ...
    for (int i = 0; i < MAX_PLATFORMS; i++)
    {
        collision = CheckCollisionRecs(player.collider, platforms[i].rect);
        if (collision)
            boxCollision = GetCollisionRec(player.collider, platforms[i].rect);
        else
        {
            player.speed.x = 0.1f;
            player.speed.y = 0.1f;
