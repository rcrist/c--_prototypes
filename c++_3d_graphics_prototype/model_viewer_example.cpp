...
int main(void)
{
    ...
    // Model tower = LoadModel("Models/models/obj/turret.obj");                 // Load OBJ model
    // Texture2D texture = LoadTexture("Models/models/obj/turret_diffuse.png"); // Load model texture
    // tower.materials[0].maps[MATERIAL_MAP_DIFFUSE].texture = texture;            // Set model diffuse texture

    Model tower = LoadModel("Models/kenney_space-kit/Models/OBJ format/alien.obj"); // Load OBJ model
    ...
    while (!WindowShouldClose()) // Detect window close button or ESC key
    {
        ...
        DrawModel(tower, towerPos, 25.0f, WHITE);
